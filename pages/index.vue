        ...
        <div class="grid gap-8 md:grid-cols-3 grid-rows">
          ...
          >
            ...
            <textarea
              ...
              placeholder="Tulis pertanyaan jenajang kelas contoh : XI SMA"
            ></textarea>
          </div>
          <div
            class="p-8 mb-8 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700 md:p-12"
          >
            ...
            <textarea
              ...
              rows="2"
              class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="Tulis pertanyaan Mata Pelajaran disini contoh : Fisika"
            ></textarea>
          </div>
          <div
            class="p-8 mb-8 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700 md:p-12"
